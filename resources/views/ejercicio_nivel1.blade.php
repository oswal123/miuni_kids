...
<head>
    ...
    <title>Miuni Kids - Nivel 1</title>
...
<body class="bg-gray-100 flex flex-col items-center min-h-screen">
    ...
    <main class="flex flex-col items-center justify-center flex-grow w-full p-8 text-center">
        <h1 class="text-green-600 text-5xl font-bold mt-6">Bienvenido a Miuni Kids - Nivel 1</h1>
        ...
        <form action="{{ route('reiniciar_nivel') }}" method="POST" onsubmit="return confirmarReinicio();">
            @csrf
